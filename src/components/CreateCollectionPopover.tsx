          ...
          <div className="grid gap-3">
            ...
            <div className="grid gap-2">
              ...
              <button
                ...
                className="flex flex-col items-center justify-center gap-1 rounded-lg border border-dashed border-stone-300 bg-stone-50 px-4 py-5 text-sm text-stone-500 transition hover:border-[color:var(--accent,#e2a87a)] hover:bg-[rgb(var(--accent-rgb,226_168_122)/0.18)]"
              >
